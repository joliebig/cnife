...
public class CompleteFunctionRefactoring {
	...
	public void moveNodes(Document from, Document pos, Document neg,
			PreprocessorOccurrence occ, String featureName) {
	...
	private void refactor(PreprocessorNode start, PreprocessorNode end,
		...
		try {
			XPathExpression expr = QueryBuilder.instance().getExpression(
					"/src:unit/src:class/src:block/src:comment");
