...
public class NewFileTemplate extends RefactoringDocument {
	...
	public static NewFileTemplate instantiate() 
	...
	public void setClassName(String className) throws XPathExpressionException {
		XPathExpression expr = QueryBuilder.instance().getExpression(CLASS_NODE_QUERY);
	...
	public void setClassName(Document doc) throws XPathExpressionException {
		...
		this.setClassName(result.getTextContent());
		
	}
	public static void main (String args[]) throws SAXException, IOException, ParserConfigurationException, XPathExpressionException {
		NewFileTemplate templ = NewFileTemplate.instantiate();
